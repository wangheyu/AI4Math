...
\begin{figure}[htbp]
  \centering
\includegraphics[width=0.75\textwidth]{figures/jpl.png}
...
\begin{figure}[htbp]
  \centering
\includegraphics[width=0.75\textwidth]{figures/qian.png}
...
\begin{itemize}[leftmargin=1.5em]
  \item 若只想获取某个单独历元的状态，可改用 \texttt{TLIST} 参数，只请求一个时刻。
  \item 若希望获取轨道要素而不是状态向量，则把 \texttt{EPHEM\_TYPE} 设为 \texttt{ELEMENTS}，而不是 \texttt{VECTORS}。
\end{itemize}
