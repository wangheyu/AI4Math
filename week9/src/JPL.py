...
OUTDIR = REPO_ROOT / "output" / "jpl_compare_output"
...
def save_outputs(
    ...
    csv_path = Path(outdir) / csv_name
    df.to_csv(csv_path, index=False, encoding="utf-8-sig")

    summary_path = Path(outdir) / summary_name
